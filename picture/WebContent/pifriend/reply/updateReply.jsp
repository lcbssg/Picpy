...
<body>
    ...
    <div class="longConCam">
    	...
    	<s:hidden name="commentReply.replyId"></s:hidden>
    	<div class="inputLong">
            ...
            <div class="vm commentFunc pt5 layout">
            	<div class="fRight right">
            		...
            		<s:submit type="button" value="提交回复" cssClass="yellowBtn mt10" method="update"></s:submit>
            		<a href="<%=basePath%>comment/commentAction!findCommentAndReplyByProduct?product.productId=<s:property value="commentReply.productComment.product.productId"/>" class="c009cff">取消回复</a>
            	</div>
            </div>
        </div>
        </s:form>
