...
<div class="doc1180 fn-clear paddingT20">
  ...
  <div class="doc910 fn-left">
    	<div class="flcb_cardMenu">
        	<ul>
            	<center><font size="5" >职位管理</font></center>
            </ul>
        </div>
        <div class="myPost">
            <div class="myPost_Theme">
            	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="myPost_Table">
                  ...
                  <s:iterator value="#request.sysJobs" var="job">
                  	<tr style="height: 30px">
                  	<td><div class="myPost_hf" ><s:property value="#job.jobName"/></div></td>
                  	<td><div class="myPost_hf" ><s:property value="#job.jobDesc"/></div></td>
                    <td>
        ...
        <div class="pageList">
        	<ul>
        	<li><a href= '<%=basePath%>pifriend/job/createJob.jsp' class="pret">创建职业</a></li>
            </ul>
        </div>
  </div>
</div>
